  ...
  */
  const connectWallet = async () => {
    try {
      ...
      console.log(prov.provider.selectedAddress.substring(0, 10));
      // provider.selectedAddress.substring(0,10)
      setWalletAddress(prov.provider.selectedAddress.substring(0, 10));
    ...
    if (walletConnected) {
      if (joinedWhitelist) {
        ...
        return (
          <div>
            <div className={styles.description}>
              Heyyy 🎉{walletAddress}🎉 <b> 33 Limited</b> Spots to whitelist! GET YOURS!
            </div>
